...
<html lang="en">
    ...
    <body>
        <div class='page'>
            ...
            <div class="welcome">
                <h1>Welcome to <span style="font-family: 'Allura', cursive; font-size: 40px;">Advanz</span> Fitness!</h1>
                <p>My name is Addison Van Zandbergen and I am the founder of <span style="font-family: 'Allura', cursive; font-size: 100%;">Advanz</span> Fitness.
